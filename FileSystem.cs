...
namespace GuildfordBoroughCouncil.IO
{
    // Source: https://github.com/hubkey/Trinet.Core.IO.Ntfs
	...
	public static class FileSystem
	{
        ...
        #region Internet Security Zone

        public static void SetSecurityZoneFromInternet(this FileSystemInfo file)
        {
            var ads = file.GetAlternateDataStream("Zone.Identifier", FileMode.OpenOrCreate);
        ...
        public static void RemoveSecurityZoneFromInternet(this FileSystemInfo file)
        {
